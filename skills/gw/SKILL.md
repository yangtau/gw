---
name: gw
description: References other coding-agent sessions on this machine. Use when asked to check on, read, wait for, or continue another supported agent session, or to coordinate work across parallel agent sessions.
